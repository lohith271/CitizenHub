...
const Login = () => {
  ...
  // Quick Demo Auto-Fill Helpers for Hackathon Judges
  ...
  return (
    <div className="min-h-[85vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8 bg-white p-8 sm:p-10 rounded-3xl border border-slate-200 shadow-xl shadow-slate-200/50">
        ...
        {/* Demo One-Click Fillers for Judges */}
        <div className="bg-slate-50 border border-slate-200/80 rounded-2xl p-3.5 space-y-2">
          <div className="text-[11px] font-bold uppercase tracking-wider text-slate-400 text-center">
            ⚡ Hackathon Quick Login (1-Click)
          </div>
          <div className="grid grid-cols-3 gap-2 text-xs">
            <button
              type="button"
              onClick={() => autoFill('rohan.designer@gmail.com', 'password123')}
              className="py-2 px-2 bg-white hover:bg-brand-50 hover:border-brand-300 border border-slate-200 rounded-lg font-bold text-slate-700 hover:text-brand-700 flex flex-col items-center gap-1 transition-all"
            >
            ...
            <button
              type="button"
              onClick={() => autoFill('arjun@jhatkaa.org', 'password123')}
              className="py-2 px-2 bg-white hover:bg-brand-50 hover:border-brand-300 border border-slate-200 rounded-lg font-bold text-slate-700 hover:text-brand-700 flex flex-col items-center gap-1 transition-all"
            >
            ...
            <button
              type="button"
              onClick={() => autoFill('admin@citizenhub.org', 'password123')}
              className="py-2 px-2 bg-white hover:bg-amber-50 hover:border-amber-300 border border-slate-200 rounded-lg font-bold text-slate-700 hover:text-amber-700 flex flex-col items-center gap-1 transition-all"
            >
